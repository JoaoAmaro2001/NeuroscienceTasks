...
data.text.getready_pt       = 'A experi�ncia come�ar� em breve... Mantenha o olhar fixo na cruz';
data.text.starting_en       = 'Starting in';
data.text.starting_pt       = 'Come�a em';
data.text.baselineClosed_en = 'Baseline with eyes closed will start shortly';
data.text.baselineClosed_pt = 'O per�odo de relaxamento com olhos fechados come�ar� em breve';
data.text.baselineOpen_en   = 'Baseline with eyes open will start shortly';
data.text.baselineOpen_pt   = 'O per�odo de relaxamento com olhos abertos come�ar� em breve';
